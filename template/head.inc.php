      ...
      <div class="px-4 relative mx-auto flex max-w-screen-lg flex-col py-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav aria-label="Header Navigation" class="peer-checked:block hidden pl-2 py-6 sm:block sm:py-0">
          <ul class="flex flex-col sm:flex-row">
            ...
            <a class="font-bold nav-link transition-all duration-200 ease-out px-4 mobile-link" href="index.php#about_me"><li class="">ABOUT ME</li></a>
            <a class="font-bold nav-link transition-all duration-200 ease-out px-4 mobile-link" id="project" href="projects.php"><li class="">PROJECTS</li></a>
            <a class="font-bold nav-link transition-all duration-200 ease-out px-4 mobile-link" href="index.php#contact"><li class="">CONTACT</li></a>
          </ul>
        </nav>
      </div>
    </nav>
